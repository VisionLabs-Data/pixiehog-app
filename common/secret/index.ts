...
const envSchema = z.object({
  /**
   * Registration UUID of the app's ONE theme app extension. Named for PostHog
   * for historical reasons — it now covers the Iris SDK block in the same
   * extension too. Blocks are told apart by handle, not by UUID.
   */
