...
export type CurrentAppInstallationQueryVariables = AdminTypes.Exact<{
  ...
  dataLayerEnabledKey: AdminTypes.Scalars['String']['input'];
  irisApiKeyKey: AdminTypes.Scalars['String']['input'];
  irisApiHostKey: AdminTypes.Scalars['String']['input'];
  irisEnabledKey: AdminTypes.Scalars['String']['input'];
  irisEcommerceSpecKey: AdminTypes.Scalars['String']['input'];
  irisJsConfigKey: AdminTypes.Scalars['String']['input'];
  irisJsFeatureToggleKey: AdminTypes.Scalars['String']['input'];
}>;


export type CurrentAppInstallationQuery = { currentAppInstallation: (
    Pick<AdminTypes.AppInstallation, 'id'>
    & { app: Pick<AdminTypes.App, 'id' | 'title' | 'handle'>, posthog_api_key?: AdminTypes.Maybe<Pick<AdminTypes.Metafield, 'key' | 'value' | 'type'>>, posthog_api_host?: AdminTypes.Maybe<Pick<AdminTypes.Metafield, 'key' | 'value' | 'type'>>, data_collection_strategy?: AdminTypes.Maybe<Pick<AdminTypes.Metafield, 'key' | 'value' | 'type'>>, web_pixel_settings?: AdminTypes.Maybe<Pick<AdminTypes.Metafield, 'key' | 'jsonValue' | 'type'>>, web_pixel_feature_toggle?: AdminTypes.Maybe<Pick<AdminTypes.Metafield, 'key' | 'jsonValue' | 'value' | 'type'>>, web_pixel_posthog_ecommerce_spec?: AdminTypes.Maybe<Pick<AdminTypes.Metafield, 'key' | 'jsonValue' | 'value' | 'type'>>, web_pixel_tracked_events?: AdminTypes.Maybe<Pick<AdminTypes.Metafield, 'key' | 'jsonValue' | 'value' | 'type'>>, js_web_posthog_config?: AdminTypes.Maybe<Pick<AdminTypes.Metafield, 'key' | 'jsonValue' | 'value' | 'type'>>, js_web_posthog_feature_toggle?: AdminTypes.Maybe<Pick<AdminTypes.Metafield, 'key' | 'jsonValue' | 'value' | 'type'>>, datalayer_enabled?: AdminTypes.Maybe<Pick<AdminTypes.Metafield, 'key' | 'jsonValue' | 'value' | 'type'>>, iris_api_key?: AdminTypes.Maybe<Pick<AdminTypes.Metafield, 'key' | 'value' | 'type'>>, iris_api_host?: AdminTypes.Maybe<Pick<AdminTypes.Metafield, 'key' | 'value' | 'type'>>, iris_enabled?: AdminTypes.Maybe<Pick<AdminTypes.Metafield, 'key' | 'jsonValue' | 'value' | 'type'>>, iris_ecommerce_spec?: AdminTypes.Maybe<Pick<AdminTypes.Metafield, 'key' | 'jsonValue' | 'value' | 'type'>>, iris_js_config?: AdminTypes.Maybe<Pick<AdminTypes.Metafield, 'key' | 'jsonValue' | 'value' | 'type'>>, iris_js_feature_toggle?: AdminTypes.Maybe<Pick<AdminTypes.Metafield, 'key' | 'jsonValue' | 'value' | 'type'>> }
  ) };
